...
Решение когда не ждем результата с бекэенда (блокируя интерфейс или часть его), а сразу изменяем на клиенте состояние. Полагаем, что на сервере все произойдет без ошибок. 
